...
// // ANSWER: No, because it is still only going to return the 4th element.  Meaning, it 
...
// // Q: What is the space complexity of this function?
// // ANSWER: O(1) because it is dependent on what the number is.
...
// // ANSWER:
// No because either way it depends on the numbers that you put in.
...
// // ANSWER: Each function returns letters and the content of the string since one is changing all the letters to lowercase, and replacing letters.
